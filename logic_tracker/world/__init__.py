...
def launch_client(*args):
    ...
    launch(TCMain, name="Custom Tracker client", args=args)
...
components.append(Component("Custom Tracker", None, func=launch_client, component_type=Type.CLIENT, icon="ut_ico"))
